(() => {
    ...
    (() => {
        ...
        function initSliders() {
            ...
            if (document.querySelector(".swiper-principles")) new core(".swiper-principles", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                autoHeight: false,
                ...
                grabCursor: true,
                navigation: {
                    prevEl: ".principles__button-prev",
                    nextEl: ".principles__button-next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1,
            ...
            if (document.querySelector(".swiper-main-block")) new core(".swiper-main-block", {
